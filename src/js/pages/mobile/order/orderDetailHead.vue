    ...
    <div class="wrapper">
        <div class="gb-box">
            <div class="gb-bg">
                ...
                <text class="gb-text" v-if="order.orderStatus != 'Unpaid' && order.orderStatus != 'Canceled' && order.orderStatus != 'Audit canceled' && order.orderStatus != 'Completed' && order.orderStatus != 'Packing'">{{order.orderStatus}}</text>
